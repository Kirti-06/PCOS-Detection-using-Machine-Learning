...
#
lbl = tk.Label(root, text="POLYCYSTIC-OVARIAN-SYNDROME DETECTION SYSTEM", font=('times', 25,' bold '), height=1, width=70,bg="Black",fg="white")
lbl.place(x=0, y=20)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D:/Ashvin/100% PCOS-Detection/PCOS Detection/Dataset', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
